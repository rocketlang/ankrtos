/**
 * Ho Chi Minh Port Tariff Scraper
 * Port Code: VNSGN
 * Country: Vietnam
 */
...
export class HoChiMinhPortScraper extends BasePortScraper {
  constructor() {
    const config: PortScraperConfig = {
      portId: 'ho-chi-minh-port',
      portName: 'Ho Chi Minh Port',
      unlocode: 'VNSGN',
      country: 'Vietnam',
      scraperType: 'html',
      sourceUrl: 'https://www.vpa.org.vn/',
      rateLimit: 5000
    };
    super(config);
  }
  ...
  async scrape(): Promise<ScrapeResult> {
    try {
      // Simulated tariff data for Ho Chi Minh Port
