...
export class DalianPortScraper extends BasePortScraper {
  constructor() {
    const config: PortScraperConfig = {
      portId: 'dalian-port',
      portName: 'Dalian Port',
      unlocode: 'CNDLC',
      country: 'China',
      scraperType: 'html',
      sourceUrl: 'http://www.dlport.cn/',
      rateLimit: 5000
    };
    super(config);
  }
  ...
  async scrape(): Promise<ScrapeResult> {
    try {
      // Simulated tariff data for Dalian Port
