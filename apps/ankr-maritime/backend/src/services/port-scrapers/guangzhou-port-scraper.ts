...
export class GuangzhouPortScraper extends BasePortScraper {
  constructor() {
    const config: PortScraperConfig = {
      portId: 'guangzhou-port',
      portName: 'Guangzhou Port',
      unlocode: 'CNGZH',
      country: 'China',
      scraperType: 'html',
      sourceUrl: 'http://www.gzport.com/',
      rateLimit: 5000
    };
    super(config);
  }
  ...
  async scrape(): Promise<ScrapeResult> {
    try {
      // Simulated tariff data for Guangzhou Port
