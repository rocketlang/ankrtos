...
| **ENTERPRISE** | + DA Desk, Laytime Calculator, Claims, P&I Club, Weather Routing, Sea Routing Engine, Mari8X LLM, Advanced Analytics, OpenSeaMap, EDI, API Access |

Set `MARI8X_TIER=pro` or `MARI8X_TIER=enterprise` in `backend/.env` to unlock tiers.
...
6. Mari8X LLM training data pipeline
