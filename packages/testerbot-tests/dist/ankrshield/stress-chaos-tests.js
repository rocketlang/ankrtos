...
exports.ankrshieldStressChaosTests = exports.ankrshieldChaosTests = exports.ankrshieldStressTests = void 0;
        ...
        fn: async (agent) => {
            ...
            for (let i = 0; i < STRESS_THRESHOLDS.MEMORY_STRESS_ITERATIONS; i++) {
                try {
                    ...
                    if (i % 10 === 0) {
                        console.warn(`  Warning at iteration ${i}: ${error.message}`);
                    }
                }
            }
            // Get final memory
            ...
            const isIncreasing = recentSnapshots.every((val, idx) => idx === 0 || val >= recentSnapshots[idx - 1]);
            ...
            if (memoryIncreaseMB > STRESS_THRESHOLDS.MAX_MEMORY_INCREASE_MB) {
                throw new Error(`Excessive memory increase: ${memoryIncreaseMB.toFixed(2)}MB (${memoryIncreasePercent.toFixed(1)}%) ` +
            ...
            if (memoryIncreasePercent > STRESS_THRESHOLDS.MAX_MEMORY_INCREASE_PERCENT) {
                throw new Error(`Excessive memory increase: ${memoryIncreasePercent.toFixed(1)}% ` +
...
exports.ankrshieldChaosTests = [
    {
        ...
        fn: async (agent) => {
            ...
            if (settingsButton) {
                ...
                // Check for console errors
                const errors = await agent.getConsoleErrors();
                const criticalErrors = errors.filter(err => err.toLowerCase().includes('uncaught') ||
...
exports.ankrshieldStressChaosTests = [
    ...exports.ankrshieldStressTests,
    ...exports.ankrshieldChaosTests
];
//# sourceMappingURL=stress-chaos-tests.js.map