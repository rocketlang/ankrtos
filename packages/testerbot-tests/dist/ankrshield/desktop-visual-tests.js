...
exports.ankrshieldDesktopVisualTests = void 0;
...
exports.ankrshieldDesktopVisualTests = [
    {
        ...
        fn: async (agent) => {
            ...
            if (!result.matches) {
                throw new Error(`Visual regression detected in desktop dashboard:\n` +
    ...
    },
    {
        ...
        fn: async (agent) => {
            ...
            if (!result.matches) {
                throw new Error(`Visual regression detected in settings UI:\n` +
                    `  - ${result.diffPercentage.toFixed(2)}% of pixels changed (${result.diffPixels} pixels)\n` +
                    `  - Diff image: ${result.diffImagePath}`);
            }
    ...
    },
    {
        ...
        fn: async (agent) => {
            ...
            if (!result.matches) {
                throw new Error(`Visual regression detected in activity feed:\n` +
                    `  - ${result.diffPercentage.toFixed(2)}% of pixels changed (${result.diffPixels} pixels)\n` +
                    `  - Diff image: ${result.diffImagePath}`);
            }
    ...
    },
    {
        ...
        fn: async (agent) => {
            ...
            if (!result.matches) {
                throw new Error(`Visual regression detected in privacy score card:\n` +
                    `  - ${result.diffPercentage.toFixed(2)}% of pixels changed (${result.diffPixels} pixels)\n` +
                    `  - Diff image: ${result.diffImagePath}`);
            }
    ...
    },
    {
        ...
        fn: async (agent) => {
            ...
            if (!result.matches) {
                throw new Error(`Visual regression detected in stats grid:\n` +
                    `  - ${result.diffPercentage.toFixed(2)}% of pixels changed (${result.diffPixels} pixels)\n` +
                    `  - Diff image: ${result.diffImagePath}`);
            }
    ...
    },
    {
        ...
        fn: async (agent) => {
            ...
            if (!result.matches) {
                throw new Error(`Visual regression detected in header:\n` +
                    `  - ${result.diffPercentage.toFixed(2)}% of pixels changed (${result.diffPixels} pixels)\n` +
                    `  - Diff image: ${result.diffImagePath}`);
            }
    ...
    },
    {
        ...
        fn: async (agent) => {
            ...
            if (!result.matches) {
                throw new Error(`Visual regression detected in full layout:\n` +
                    `  - ${result.diffPercentage.toFixed(2)}% of pixels changed (${result.diffPixels} pixels)\n` +
                    `  - Threshold: 1.0%\n` +
                    `  - Diff image: ${result.diffImagePath}\n` +
    ...
    },
    {
        ...
        fn: async (agent) => {
            ...
            if (!result.matches) {
                throw new Error(`Visual regression detected in modal dialog:\n` +
                    `  - ${result.diffPercentage.toFixed(2)}% of pixels changed (${result.diffPixels} pixels)\n` +
                    `  - Diff image: ${result.diffImagePath}`);
            }
...
//# sourceMappingURL=desktop-visual-tests.js.map