...
exports.ankrshieldVisualTests = [
    ...
    },
    {
        ...
        fn: async (agent) => {
            ...
            if (!result.matches) {
                throw new Error(`Visual regression detected in dark mode:\n` +
    ...
    },
    {
        ...
        fn: async (agent) => {
            ...
            if (!result.matches) {
                throw new Error(`Visual regression detected in mobile layout:\n` +
                    `  - ${result.diffPercentage.toFixed(2)}% of pixels changed (${result.diffPixels} pixels)\n` +
                    `  - Diff image: ${result.diffImagePath}`);
            }
    ...
    },
    {
        ...
        fn: async (agent) => {
            ...
            if (!result.matches) {
                throw new Error(`Visual regression detected in tablet layout:\n` +
                    `  - ${result.diffPercentage.toFixed(2)}% of pixels changed (${result.diffPixels} pixels)\n` +
                    `  - Diff image: ${result.diffImagePath}`);
            }
    ...
    },
    {
        ...
        fn: async (agent) => {
            ...
            if (!result.matches) {
                throw new Error(`Visual regression detected in settings page:\n` +
                    `  - ${result.diffPercentage.toFixed(2)}% of pixels changed (${result.diffPixels} pixels)\n` +
                    `  - Diff image: ${result.diffImagePath}`);
            }
    ...
    },
    {
        ...
        fn: async (agent) => {
            ...
            if (!result.matches) {
                throw new Error(`Visual regression detected in form elements:\n` +
                    `  - ${result.diffPercentage.toFixed(2)}% of pixels changed (${result.diffPixels} pixels)\n` +
                    `  - Diff image: ${result.diffImagePath}`);
            }
