...
\restrict BWN7yU0Yb6FDisACUJVrhdj0xhTZ2wMmGufvGOwPklE7BUTvREhU0qr8VNTlD2V
...
--
-- Name: FilingAuditLog; Type: TABLE; Schema: compliance; Owner: ankr
--

CREATE TABLE compliance."FilingAuditLog" (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    "draftId" uuid NOT NULL,
    action character varying(50) NOT NULL,
    "fromStatus" character varying(20),
    "toStatus" character varying(20),
    "performedBy" text NOT NULL,
    "performedByRole" character varying(50),
    changes jsonb,
    reason text,
...
ALTER TABLE compliance."FilingAuditLog" OWNER TO ankr;

--
-- Name: FilingDraft; Type: TABLE; Schema: compliance; Owner: ankr
--

CREATE TABLE compliance."FilingDraft" (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    "companyId" text NOT NULL,
    "calendarItemId" text,
    "ruleId" character varying(50) NOT NULL,
...
ALTER TABLE compliance."FilingDraft" OWNER TO ankr;
...
--
-- Data for Name: FilingAuditLog; Type: TABLE DATA; Schema: compliance; Owner: ankr
--

COPY compliance."FilingAuditLog" (id, "draftId", action, "fromStatus", "toStatus", "performedBy", "performedByRole", changes, reason, "ipAddress", "userAgent", "createdAt") FROM stdin;
\.


--
-- Data for Name: FilingDraft; Type: TABLE DATA; Schema: compliance; Owner: ankr
--

COPY compliance."FilingDraft" (id, "companyId", "calendarItemId", "ruleId", "filingPeriod", status, data, "validationErrors", "validationWarnings", "preparedBy", "reviewedBy", "approvedBy", "approvedAt", "generatedDocuments", "createdAt", "updatedAt") FROM stdin;
\.
...
--
-- Name: FilingAuditLog FilingAuditLog_pkey; Type: CONSTRAINT; Schema: compliance; Owner: ankr
--

ALTER TABLE ONLY compliance."FilingAuditLog"
    ADD CONSTRAINT "FilingAuditLog_pkey" PRIMARY KEY (id);


--
-- Name: FilingDraft FilingDraft_pkey; Type: CONSTRAINT; Schema: compliance; Owner: ankr
--

ALTER TABLE ONLY compliance."FilingDraft"
    ADD CONSTRAINT "FilingDraft_pkey" PRIMARY KEY (id);
...
--
-- Name: FilingAuditLog_action_idx; Type: INDEX; Schema: compliance; Owner: ankr
--

CREATE INDEX "FilingAuditLog_action_idx" ON compliance."FilingAuditLog" USING btree (action);


--
-- Name: FilingAuditLog_draftId_idx; Type: INDEX; Schema: compliance; Owner: ankr
--

CREATE INDEX "FilingAuditLog_draftId_idx" ON compliance."FilingAuditLog" USING btree ("draftId");


--
-- Name: FilingAuditLog_performedBy_idx; Type: INDEX; Schema: compliance; Owner: ankr
--

CREATE INDEX "FilingAuditLog_performedBy_idx" ON compliance."FilingAuditLog" USING btree ("performedBy");


--
-- Name: FilingDraft_companyId_idx; Type: INDEX; Schema: compliance; Owner: ankr
--

CREATE INDEX "FilingDraft_companyId_idx" ON compliance."FilingDraft" USING btree ("companyId");


--
-- Name: FilingDraft_filingPeriod_idx; Type: INDEX; Schema: compliance; Owner: ankr
--

CREATE INDEX "FilingDraft_filingPeriod_idx" ON compliance."FilingDraft" USING btree ("filingPeriod");


--
-- Name: FilingDraft_ruleId_idx; Type: INDEX; Schema: compliance; Owner: ankr
--

CREATE INDEX "FilingDraft_ruleId_idx" ON compliance."FilingDraft" USING btree ("ruleId");


--
-- Name: FilingDraft_status_idx; Type: INDEX; Schema: compliance; Owner: ankr
--

CREATE INDEX "FilingDraft_status_idx" ON compliance."FilingDraft" USING btree (status);
...
--
-- Name: FilingAuditLog FilingAuditLog_draftId_fkey; Type: FK CONSTRAINT; Schema: compliance; Owner: ankr
--

ALTER TABLE ONLY compliance."FilingAuditLog"
    ADD CONSTRAINT "FilingAuditLog_draftId_fkey" FOREIGN KEY ("draftId") REFERENCES compliance."FilingDraft"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: FilingDraft FilingDraft_calendarItemId_fkey; Type: FK CONSTRAINT; Schema: compliance; Owner: ankr
--

ALTER TABLE ONLY compliance."FilingDraft"
    ADD CONSTRAINT "FilingDraft_calendarItemId_fkey" FOREIGN KEY ("calendarItemId") REFERENCES compliance."ComplianceCalendar"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: FilingDraft FilingDraft_companyId_fkey; Type: FK CONSTRAINT; Schema: compliance; Owner: ankr
--

ALTER TABLE ONLY compliance."FilingDraft"
    ADD CONSTRAINT "FilingDraft_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES compliance."Company"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
\unrestrict BWN7yU0Yb6FDisACUJVrhdj0xhTZ2wMmGufvGOwPklE7BUTvREhU0qr8VNTlD2V
